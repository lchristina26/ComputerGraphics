...
set(Qt5WebView_VERSION_STRING 5.4.0)
...
macro(_populate_WebView_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set_target_properties(Qt5::WebView PROPERTIES
        ...
        "IMPORTED_SONAME_${Configuration}" "libQt5WebView.so"
...
if (NOT TARGET Qt5::WebView)
    ...
    set(_Qt5WebView_MODULE_DEPENDENCIES "Quick;Gui;Qml;Core")
    ...
    foreach(_module_dep ${_Qt5WebView_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.4.0 ${_Qt5WebView_FIND_VERSION_EXACT}
    ...
    set(_Qt5WebView_LIB_DEPENDENCIES "Qt5::Quick;Qt5::Gui;Qt5::Qml;Qt5::Core")
    ...
    _populate_WebView_target_properties(RELEASE "libQt5WebView.so" "" )
